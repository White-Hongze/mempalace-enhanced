...
# 自动去除 macOS 隔离标记（Gatekeeper），避免"无法验证开发者"拦截
...
stable   = os.path.expanduser('~/Library/Application Support/Code/User/settings.json')
insiders = os.path.expanduser('~/Library/Application Support/Code - Insiders/User/settings.json')
